...
continent_df = pd.read_excel("Continent(1).xlsx")
region_df = pd.read_excel("Region(1).xlsx")
country_df = pd.read_excel("Country(1).xlsx")
city_df = pd.read_excel("City(1).xlsx")
mode_df = pd.read_excel("Mode(1).xlsx")
type_df = pd.read_excel("Type(1).xlsx")
transaction_df = pd.read_excel("Transaction(1).xlsx")
item_df = pd.read_excel("Item(1).xlsx")
updated_item_df = pd.read_excel("Updated_Item(1).xlsx")
user_df = pd.read_excel("User(1).xlsx")
